...
async def cb_data(bot, update):
  ...
  if (update.data.startswith("['ChangePage'")):
    ...
    await Client.edit_inline_reply_markup(bot,inline_message_id = str(update.message.message_id),reply_markup=helper.MoreBots_BTN)#InlineKeyboardMarkup([[InlineKeyboardButton("New button", callback_data="new_data")]]))
