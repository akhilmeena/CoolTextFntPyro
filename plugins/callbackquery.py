...
async def cb_data(bot, update):
  ...
  if (update.data.startswith("['ChangePage'")):
    ...
    await bot.edit_inline_text(inline_message_id = update.message.result_id,text="akhil")#reply_markup=helper.MoreBots_BTN)#InlineKeyboardMarkup([[InlineKeyboardButton("New button", callback_data="new_data")]]))
