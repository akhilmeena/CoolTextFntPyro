...
async def cb_data(bot, update):
  ...
  if (update.data.startswith("['ChangePage'")):
    ...
    await Client.edit_inline_text(inline_message_id = str(update.message.message_id),text="akhil")#reply_markup=helper.MoreBots_BTN)#InlineKeyboardMarkup([[InlineKeyboardButton("New button", callback_data="new_data")]]))
