...
async def cb_data(bot, update):
  ...
  if (update.data.startswith("['ChangePage'")):
    ...
    await update.edit_message_reply_markup(reply_markup=helper.MoreBots_BTN)#inline_message_id = update.message.message_id,text="akhil")#reply_markup=helper.MoreBots_BTN)#InlineKeyboardMarkup([[InlineKeyboardButton("New button", callback_data="new_data")]]))
